...
// 	//		newBook.PageInfos = append(newBook.PageInfos, types.MediaFileInfo{RealImageFilePATH: "", Size: MediaFileInfo.Size(), ModTime: MediaFileInfo.ModTime(), Name: strconv.Itoa(i), Url: TempURL})
// 	//	}
...
// 	//				//newBook.AllPage = append(newBook.AllPage, MediaFileInfo{RealImageFilePATH: "", Size: f.Size(), ModTime: f.ModTime(), Name: "", Url: "/cache/" + newBook.BookID + "/" + url.QueryEscape(path)})
// 	//				//实验：用get_file接口提供文件服务
// 	//				TempURL := "/api/get_file?id=" + newBook.BookID + "&filename=" + url.QueryEscape(path)
// 	//				newBook.PageInfos = append(newBook.PageInfos, types.MediaFileInfo{RealImageFilePATH: "", Size: f.Size(), ModTime: f.ModTime(), Name: "", Url: TempURL})
...
// 	//				newBook.PageInfos = append(newBook.PageInfos, types.MediaFileInfo{RealImageFilePATH: "", Size: f.Size(), ModTime: f.ModTime(), Name: u.Name, Url: TempURL})
// 	//			}
// 	//		}
// 	//		return nil
// 	//	})
...
// 			newBook.PageInfos = append(newBook.PageInfos, model.MediaFileInfo{Path: strAbsPath, Size: file.Size(), ModTime: file.ModTime(), Name: file.Name(), Url: TempURL})
// 		}
// 	}
// 	newBook.SortPages("default")
// 	// 在添加到书库时判断页数

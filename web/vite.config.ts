...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "^/api/(server_info|raw|book_infos|top_shelf|get_book|get_file|config.toml|comigo.reg|qrcode.png|redirect|upload|form|raw|login|logout|form|group_info_filter|parent_book_info|generate_image).*":
        {

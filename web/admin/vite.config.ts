...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "^/api/(server_info|server_info_all|book_infos|get_book|get_file|config.toml|config|config_save|comigo.reg|qrcode.png|redirect|upload|form|raw|login|logout|form).*":
        {

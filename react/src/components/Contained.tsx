...
const Contained: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      <button
        className={`${group === "bookstore" ? " bg-white text-blue-500" : "text-gray-500 hover:text-gray-700"} inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-semibold shadow-sm focus:relative `}
      ...
      <button
        className={`${group === "internet" ? " bg-white text-blue-500" : "text-gray-500 hover:text-gray-700"} inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm shadow-sm font-semibold focus:relative `}
      ...
      <button
        className={`${group === "other" ? " bg-white text-blue-500" : "text-gray-500 hover:text-gray-700"} inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm shadow-sm font-semibold focus:relative `}

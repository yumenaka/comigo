...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "^/api/(get_server_info_public|get_server_info|get_book_infos_by_depth|get_book_infos_by_max_depth|get_book_infos_by_group_id|get_book|get_file|config.toml|config|config_save|comigo.reg|qrcode.png|redirect|upload|form|raw|login|logout|form).*":
        {

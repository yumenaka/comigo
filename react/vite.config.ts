...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "^/api/(server_info_public|get_book_infos|get_book|get_file|config.toml|config.json|config_update|config_save|comigo.reg|qrcode.png|redirect|upload|form|raw|login|logout|form).*":
        {

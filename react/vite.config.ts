...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "^/api/(getstatus|getlist|getbook|getfile|config.toml|config.json|update_config|post_config|comigo.reg|qrcode.png|redirect|upload|form|raw|login|logout|form).*":
        {

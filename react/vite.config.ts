...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "^/api/(get_status|getlist|getbook|getfile|config.toml|config.json|config_update|config_save|comigo.reg|qrcode.png|redirect|upload|form|raw|login|logout|form).*":
        {

...
Alpine.store('global', {
    ...
    getCoverURL (bookInfo, resizeHeight = 352) {
        ...
        const coverURL = $8def34bab28fb2bd$var$setURLQueryParam(rawCoverURL, "resize_height", resizeHeight);
     ...
     */ async UpdateBookmark ({ type: type = 'auto', bookId: bookId, pageIndex: pageIndex, description: description = '' } = {}) {
        ...
        const response = await fetch($8def34bab28fb2bd$var$comigoPath('/api/store-bookmark'), {
            method: 'POST',
            headers: {

...
class $1bac384020b50752$var$Interpolator {
    ...
    nest(str, fc) {
        ...
        while(match = this.nestingRegexp.exec(str)){
            ...
            if (doReduce) value = formatters.reduce((v, f)=>this.format(v, f, options1.lng, {
                    ...options1,
...
const $1bac384020b50752$var$createCachedFormatter = (fn)=>{
    ...
    return (val, lng, options1)=>{
        ...
        if (options1 && options1.interpolationkey && options1.formatParams && options1.formatParams[options1.interpolationkey] && options1[options1.interpolationkey]) optForCache = {
            ...optForCache,
        ...
        if (!formatter) {
            formatter = fn($1bac384020b50752$var$getCleanedCode(lng), options1);
            cache[key] = formatter;
        }

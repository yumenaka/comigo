...
const $1bac384020b50752$var$cleanKey = (key)=>key && key.includes('###') ? key.replace($1bac384020b50752$var$lastOfPathSeparatorRegExp, '.') : key;
...
const $1bac384020b50752$var$_entityMap = {
    '&': '&amp;',
    '<': '&lt;',
    '>': '&gt;',
    '"': '&quot;',
...
const $1bac384020b50752$var$looksLikeObjectPath = (key, nsSeparator, keySeparator)=>{
    ...
    const possibleChars = $1bac384020b50752$var$chars.filter((c)=>!nsSeparator.includes(c) && !keySeparator.includes(c));
...
const $1bac384020b50752$var$getCleanedCode = (code)=>code?.replace(/_/g, '-');
...
class $1bac384020b50752$var$Translator extends $1bac384020b50752$var$EventEmitter {
    ...
    translate(keys, o, lastKey) {
        ...
        keys = keys.map((k)=>typeof k === 'function' ? $1bac384020b50752$export$ec2cccc18ab4c2ae(k, {
                ...this.options,
                ...opt
            }) : String(k));
        ...
        if (handleAsObjectInI18nFormat && resForObjHndl && handleAsObject && !noObject.includes(resType) && !($1bac384020b50752$var$isString(joinArrays) && Array.isArray(resForObjHndl))) {
    ...
    resolve(keys, opt = {}) {
        ...
        if (Array.isArray(keys)) keys = keys.map((k)=>typeof k === 'function' ? $1bac384020b50752$export$ec2cccc18ab4c2ae(k, {
                ...this.options,
                ...opt
            }) : k);
        keys.forEach((k)=>{
...
class $1bac384020b50752$var$LanguageUtil {
    ...
    formatLanguageCode(code) {
        if ($1bac384020b50752$var$isString(code) && code.includes('-')) {
            let formattedCode;
            try {
    ...
    toResolveHierarchy(code, fallbackCode) {
        ...
        if ($1bac384020b50752$var$isString(code) && (code.includes('-') || code.includes('_'))) {
...
class $1bac384020b50752$var$Interpolator {
    ...
    nest(str, fc, options = {}) {
        ...
        const handleHasOptions = (key, inheritedOptions)=>{
            ...
            const c = key.split(new RegExp(`${$1bac384020b50752$var$regexEscape(sep)}[ ]*{`));
...
class $1bac384020b50752$var$I18n extends $1bac384020b50752$var$EventEmitter {
    ...
    getFixedT(lng, ns, keyPrefix) {
        const fixedT = (key, opts, ...rest)=>{
            ...
            if (typeof o.keyPrefix === 'function') o.keyPrefix = $1bac384020b50752$export$ec2cccc18ab4c2ae(o.keyPrefix, selectorOpts);
            const keySeparator = this.options.keySeparator || '.';
            let resultKey;
            if (o.keyPrefix && Array.isArray(key)) resultKey = key.map((k)=>{
                if (typeof k === 'function') k = $1bac384020b50752$export$ec2cccc18ab4c2ae(k, selectorOpts);
                return `${o.keyPrefix}${keySeparator}${k}`;
            });
            else {
                if (typeof key === 'function') key = $1bac384020b50752$export$ec2cccc18ab4c2ae(key, selectorOpts);
...
var $8c83eaf28779ff46$var$transactionActive = false;
function $8c83eaf28779ff46$var$scheduler(callback) {
    $8c83eaf28779ff46$var$queueJob(callback);
}
function $8c83eaf28779ff46$var$startTransaction() {
    $8c83eaf28779ff46$var$transactionActive = true;
}
function $8c83eaf28779ff46$var$commitTransaction() {
    $8c83eaf28779ff46$var$transactionActive = false;
...
function $8c83eaf28779ff46$var$queueFlush() {
    if (!$8c83eaf28779ff46$var$flushing && !$8c83eaf28779ff46$var$flushPending) {
        if ($8c83eaf28779ff46$var$transactionActive) return;
...
async function $8c83eaf28779ff46$var$transaction(callback) {
    $8c83eaf28779ff46$var$startTransaction();
    try {
        await callback();
        await Promise.resolve();
    } finally{
        $8c83eaf28779ff46$var$commitTransaction();
    }
}
...
function $8c83eaf28779ff46$var$keyInPrototypeChain(obj, key) {
    if (obj === null || obj === Object.prototype) return null;
    if (Object.prototype.hasOwnProperty.call(obj, key)) return obj;
    return $8c83eaf28779ff46$var$keyInPrototypeChain(Object.getPrototypeOf(obj), key);
}
var $8c83eaf28779ff46$var$mergeProxyTrap = {
    ...
    set ({ objects: objects }, name, value, thisProxy) {
        ...
        for (const obj of objects){
            target = $8c83eaf28779ff46$var$keyInPrototypeChain(obj, name);
            if (target) break;
        }
...
var $8c83eaf28779ff46$var$theEvaluatorFunction = ()=>{};
...
function $8c83eaf28779ff46$var$dispatch(el, name, detail = {}, options = {}) {
...
function $8c83eaf28779ff46$var$findClosest(el, callback) {
    ...
    if (el._x_teleportBack) return $8c83eaf28779ff46$var$findClosest(el._x_teleportBack, callback);
...
function $8c83eaf28779ff46$var$splitClasses(classString) {
    return classString.split(/\s/).filter(Boolean);
}
function $8c83eaf28779ff46$var$setClassesFromString(el, classString) {
    let missingClasses = (classString2)=>$8c83eaf28779ff46$var$splitClasses(classString2).filter((i)=>!el.classList.contains(i)).filter(Boolean);
...
function $8c83eaf28779ff46$var$setClassesFromObject(el, classObject) {
    let forAdd = Object.entries(classObject).flatMap(([classString, bool])=>bool ? $8c83eaf28779ff46$var$splitClasses(classString) : false).filter(Boolean);
    let forRemove = Object.entries(classObject).flatMap(([classString, bool])=>!bool ? $8c83eaf28779ff46$var$splitClasses(classString) : false).filter(Boolean);
    let added = [];
    let removed = [];
    forRemove.forEach((i)=>{
...
var $8c83eaf28779ff46$var$Alpine = {
    ...
    get transaction () {
        return $8c83eaf28779ff46$var$transaction;
    },
    version: "3.15.11",
...
function $8c83eaf28779ff46$var$on(el, event, modifiers, callback) {
    ...
    handler4 = $8c83eaf28779ff46$var$addDebounceOrThrottle(modifiers, handler4);
...
function $8c83eaf28779ff46$var$addDebounceOrThrottle(modifiers, handler4) {
...
$8c83eaf28779ff46$var$directive("model", (el, { modifiers: modifiers, expression: expression }, { effect: effect3, cleanup: cleanup2 })=>{
    let scopeTarget = el;
    if (modifiers.includes("parent")) scopeTarget = $8c83eaf28779ff46$var$findClosest(el, (element)=>element !== el);
    ...
    let removeListener;
    if ($8c83eaf28779ff46$var$isCloning) removeListener = ()=>{};
    else if (hasExplicitEventModifiers) {
        let listeners = [];
        let syncValue = (e)=>setValue($8c83eaf28779ff46$var$getInputValue(el, modifiers, e, getValue()));
        if (hasChangeModifier) listeners.push($8c83eaf28779ff46$var$on(el, "change", modifiers, syncValue));
        if (hasBlurModifier) {
            listeners.push($8c83eaf28779ff46$var$on(el, "blur", modifiers, syncValue));
            if (el.form) {
                let form = el.form;
        ...
        if (hasEnterModifier) listeners.push($8c83eaf28779ff46$var$on(el, "keydown", modifiers, (e)=>{
        ...
        removeListener = $8c83eaf28779ff46$var$on(el, event, modifiers, (e)=>{
    ...
    el._x_model = {
        ...
        setWithModifiers: $8c83eaf28779ff46$var$addDebounceOrThrottle(modifiers, setValue)
    };
    el._x_forceModelUpdate = (value)=>{
        if (value === void 0 && typeof expression === "string" && expression.match(/\./)) value = "";
        $8c83eaf28779ff46$var$mutateDom(()=>{
            if ($8c83eaf28779ff46$var$isCheckbox(el)) {
                if (Array.isArray(value)) el.checked = value.some((val)=>val == el.value);
                else el.checked = !!value;
            } else if ($8c83eaf28779ff46$var$isRadio(el)) {
                if (typeof value === "boolean") el.checked = $8c83eaf28779ff46$var$safeParseBoolean(el.value) === value;
                else el.checked = el.value == value;
            } else $8c83eaf28779ff46$var$bind(el, "value", value);
        });
    };
    effect3(()=>{
        let value = getValue();
...
$8c83eaf28779ff46$var$directive("for", (el, { expression: expression }, { effect: effect3, cleanup: cleanup2 })=>{
    ...
    cleanup2(()=>{
        el._x_lookup.forEach((el2)=>$8c83eaf28779ff46$var$mutateDom(()=>{
...
function $8c83eaf28779ff46$var$refreshScope(scope2) {
    return (newScope)=>{
...
function $8c83eaf28779ff46$var$loop(templateEl, iteratorNames, evaluateItems, evaluateKey) {
    evaluateItems((items)=>{
        if ($8c83eaf28779ff46$var$isNumeric3(items)) items = Array.from({
            length: items
        }, (_, i)=>i + 1);
        if (items === void 0) items = [];
        ...
        let hasStringKeys = $8c83eaf28779ff46$var$isObject2(items);
        let scopeEntries = Object.entries(items).map(([index, item])=>{
            if (!hasStringKeys) index = parseInt(index);
            let scope2 = $8c83eaf28779ff46$var$getIterationScopeVariables(iteratorNames, item, index, items);
            let key;
            evaluateKey((innerKey)=>{
                if (typeof innerKey === "object") $8c83eaf28779ff46$var$warn("x-for key cannot be an object, it must be a string or an integer", templateEl);
        ...
        $8c83eaf28779ff46$var$mutateDom(()=>{
            oldLookup.forEach((el)=>{
                $8c83eaf28779ff46$var$destroyTree(el);
                el.remove();
            });
            ...
            scopeEntries.forEach(([key, scope2])=>{
                ...
                if (templateEl.content.children.length > 1) $8c83eaf28779ff46$var$warn("x-for templates require a single root element, additional elements will be ignored.", templateEl);
                ...
                clone2._x_refreshXForScope = $8c83eaf28779ff46$var$refreshScope(reactiveScope);
                lookup.set(key, clone2);
                added.add(clone2);
                prev.after(clone2);
                prev = clone2;
            });
            $8c83eaf28779ff46$var$skipDuringClone(()=>added.forEach((clone2)=>$8c83eaf28779ff46$var$initTree(clone2)))();
        });
    });
}
...
function $8c83eaf28779ff46$var$isObject2(subject) {
 ...
 */ function $fdee9bb4d54e06d0$var$shouldEnableComigoSSE() {
...
function $fdee9bb4d54e06d0$var$showReloadPrompt(reason) {
    ...
    showMessage({
        message: $fdee9bb4d54e06d0$var$getReloadPromptMessage(reason),
...
function $fdee9bb4d54e06d0$var$appendSharedLog(line) {
    if (typeof window.__comigoLogAppend === 'function') window.__comigoLogAppend(line);
}
function $fdee9bb4d54e06d0$var$comigoAttachSSEListeners(es) {
    es.addEventListener('ui_suggest_reload', (e)=>{
        ...
        $fdee9bb4d54e06d0$var$showReloadPrompt(reason);
    });
    es.addEventListener('log', (e)=>{
        $fdee9bb4d54e06d0$var$appendSharedLog(e.data);
    });
    es.addEventListener('tick', (e)=>{
        $fdee9bb4d54e06d0$var$appendSharedLog('[tick] ' + e.data);
    });
    es.onmessage = (e)=>{
        if (typeof showToast === 'function') showToast(e.data, 'info');
        $fdee9bb4d54e06d0$var$appendSharedLog('<span style="color:oklch(62.7% 0.194 149.214)">[message]</span>' + e.data);
    };
    es.onopen = ()=>{
        const text = typeof i18next !== 'undefined' && i18next.t ? i18next.t('settings_log_sse_connected') : 'SSE connected';
        $fdee9bb4d54e06d0$var$appendSharedLog('<span style="color:oklch(62.7% 0.194 149.214)">[open]</span> ' + text);
    };
    es.onerror = ()=>{
        ...
        $fdee9bb4d54e06d0$var$appendSharedLog('<span style="color:oklch(57.7% 0.245 27.325)">[error]</span> ' + text);
    };
}
function $fdee9bb4d54e06d0$var$comigoSSEInit() {
    if (!$fdee9bb4d54e06d0$var$shouldEnableComigoSSE()) return null;
    if (window.__comigoSSEInstance) return window.__comigoSSEInstance;
    const es = new EventSource('/api/sse', {
        withCredentials: true
    });
    window.__comigoSSEInstance = es;
    $fdee9bb4d54e06d0$var$comigoAttachSSEListeners(es);
    return es;
}
window.__comigoSSEInit = $fdee9bb4d54e06d0$var$comigoSSEInit;
window.dispatchEvent(new Event('comigo:sse-ready'));
$fdee9bb4d54e06d0$var$comigoSSEInit();

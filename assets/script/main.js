...
(0, $1bac384020b50752$export$2e2bcd8739ae039).use((0, $199830a05f92d3d0$export$2e2bcd8739ae039)).init({
    ...
    resources: {
        'en-US': {
            translation: (0, (/*@__PURE__*/$parcel$interopDefault($e1e4b6e0eb41aa09$exports)))
        },
        en: {
            translation: (0, (/*@__PURE__*/$parcel$interopDefault($e1e4b6e0eb41aa09$exports)))
        },
        'zh-CN': {
            translation: (0, (/*@__PURE__*/$parcel$interopDefault($2ff468c6c0b884f3$exports)))
        },
        zh: {
            translation: (0, (/*@__PURE__*/$parcel$interopDefault($2ff468c6c0b884f3$exports)))
        },
        'ja-JP': {
            translation: (0, (/*@__PURE__*/$parcel$interopDefault($357f303ddd59d8cf$exports)))
        },
        ja: {
            translation: (0, (/*@__PURE__*/$parcel$interopDefault($357f303ddd59d8cf$exports)))
        }

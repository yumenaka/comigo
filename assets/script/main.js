...
if (($44c4cdff956056b5$var$url.protocol === 'http:' || $44c4cdff956056b5$var$url.protocol === 'https:') && !window.location.toString().endsWith('.html')) Alpine.store('global').onlineBook = true;

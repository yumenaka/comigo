...
Alpine.store('global', {
     ...
     */ async UpdateBookmark ({ type: type = 'auto', bookId: bookId, pageIndex: pageIndex, label: label = "\u81EA\u52A8\u4E66\u7B7E" } = {}) {
        if (!bookId) {
        ...
        const deviceDescription = `${$3d5cedefbd41a457$var$browser} in ${$3d5cedefbd41a457$var$system}`;
        const payload = {
            type: type,
            book_id: bookId,

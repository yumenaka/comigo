...
class $1bac384020b50752$var$Logger {
    ...
    clone(options1) {
        ...
        return new $1bac384020b50752$var$Logger(this.logger, options1);
    }
}
...
class $1bac384020b50752$var$Translator extends $1bac384020b50752$var$EventEmitter {
    ...
    getUsedParamsDetails(options1 = {}) {
        ...
        const useOptionsReplaceForData = options1.replace && !$1bac384020b50752$var$isString(options1.replace);
        let data = useOptionsReplaceForData ? options1.replace : options1;
        if (useOptionsReplaceForData && typeof options1.count !== 'undefined') data.count = options1.count;
        if (this.options.interpolation.defaultVariables) data = {
            ...this.options.interpolation.defaultVariables,
            ...data
        };
    ...
    static hasDefaultValue(options1) {
        ...
        for(const option in options1){
            if (Object.prototype.hasOwnProperty.call(options1, option) && prefix === option.substring(0, prefix.length) && undefined !== options1[option]) return true;
        }
        return false;
    }
}
...
class $1bac384020b50752$var$PluralResolver {
    ...
    getSuffixes(code, options1 = {}) {
        ...
        if (!rule) rule = this.getRule('dev', options1);
        if (!rule) return [];
        return rule.resolvedOptions().pluralCategories.sort((pluralCategory1, pluralCategory2)=>$1bac384020b50752$var$suffixesOrder[pluralCategory1] - $1bac384020b50752$var$suffixesOrder[pluralCategory2]).map((pluralCategory)=>`${this.options.prepend}${options1.ordinal ? `ordinal${this.options.prepend}` : ''}${pluralCategory}`);
    }
    getSuffix(code, count, options1 = {}) {
        const rule = this.getRule(code, options1);
        if (rule) return `${this.options.prepend}${options1.ordinal ? `ordinal${this.options.prepend}` : ''}${rule.select(count)}`;
...
class $1bac384020b50752$var$Interpolator {
        ...
        todos.forEach((todo)=>{
            ...
            while(match = todo.regex.exec(str)){
                ...
                if (value === undefined) {
                    ...
                    } else if (options1 && Object.prototype.hasOwnProperty.call(options1, matchedVar)) value = '';
    ...
    nest(str, fc, options1 = {}) {
        ...
        while(match = this.nestingRegexp.exec(str)){
            ...
            if (formatters.length) value = formatters.reduce((v, f)=>this.format(v, f, options1.lng, {
                    ...options1,
...
class $1bac384020b50752$var$Formatter {
    ...
    init(services, options1 = {
        ...
        const cf = options1.cacheInBuiltFormats ? $1bac384020b50752$var$createCachedFormatter : $1bac384020b50752$var$createNonCachedFormatter;
        this.formats = {
            number: cf((lng, opt)=>{
...
class $1bac384020b50752$var$Connector extends $1bac384020b50752$var$EventEmitter {
    ...
    queueLoad(languages, namespaces, options1, callback) {
        ...
        languages.forEach((lng)=>{
            ...
            namespaces.forEach((ns)=>{
                const name = `${lng}|${ns}`;
                if (!options1.reload && this.store.hasResourceBundle(lng, ns)) this.state[name] = 2;
...
const $1bac384020b50752$var$transformOptions = (options1)=>{
    if ($1bac384020b50752$var$isString(options1.ns)) options1.ns = [
        options1.ns
    ];
    if ($1bac384020b50752$var$isString(options1.fallbackLng)) options1.fallbackLng = [
        options1.fallbackLng
    ];
    if ($1bac384020b50752$var$isString(options1.fallbackNS)) options1.fallbackNS = [
        options1.fallbackNS
    ];
    if (options1.supportedLngs?.indexOf?.('cimode') < 0) options1.supportedLngs = options1.supportedLngs.concat([
        'cimode'
    ]);
...
class $1bac384020b50752$var$I18n extends $1bac384020b50752$var$EventEmitter {
    constructor(options1 = {}, callback){
        super();
        this.options = $1bac384020b50752$var$transformOptions(options1);
        this.services = {};
    ...
    init(options1 = {}, callback) {
        ...
        if (options1.defaultNS == null && options1.ns) {
            if ($1bac384020b50752$var$isString(options1.ns)) options1.defaultNS = options1.ns;
            else if (options1.ns.indexOf('translation') < 0) options1.defaultNS = options1.ns[0];
        }
        const defOpts = $1bac384020b50752$var$get();
        this.options = {
            ...defOpts,
            ...this.options,
            ...$1bac384020b50752$var$transformOptions(options1)
        };
        this.options.interpolation = {
            ...defOpts.interpolation,
            ...this.options.interpolation
        };
        if (options1.keySeparator !== undefined) this.options.userDefinedKeySeparator = options1.keySeparator;
        if (options1.nsSeparator !== undefined) this.options.userDefinedNsSeparator = options1.nsSeparator;
        ...
        if (!this.options.isClone) {
            ...
            if (usingLegacyFormatFunction) this.logger.warn(`init: you are still using the legacy format function, please use the new approach: https://www.i18next.com/translation-function/formatting`);
    ...
    static createInstance(options1 = {}, callback) {
        return new $1bac384020b50752$var$I18n(options1, callback);
    }
    cloneInstance(options1 = {}, callback = $1bac384020b50752$var$noop) {
        ...
        if (options1.debug !== undefined || options1.prefix !== undefined) clone.logger = clone.logger.clone(options1);
        const membersToCopy = [
            'store',
            'services',
            'language'

...
func wsHandler(c *gin.Context) {
	...
	for {
		...
		fmt.Println(msg)
		//客户端请求更换书籍
		if msg.Message == "ChangeBook" && msg.NowBookUUID != common.ReadingBook.UUID {
		...
		//返回漫画压缩包解压状态
		if msg.Message == "CheckExtract" && msg.NowBookUUID == common.ReadingBook.UUID {
		...
		//
		if msg.Message == "MasterDevicesSync" && msg.NowBookUUID == common.ReadingBook.UUID {
			common.ReadingBook.ReadPercent = msg.ReadPercent
		}
		//
		if msg.Message == "SlaveDevicesSync" && msg.NowBookUUID == common.ReadingBook.UUID {
			common.ReadingBook.ReadPercent = msg.ReadPercent
		}
		fmt.Println(msg)

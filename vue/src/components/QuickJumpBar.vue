<template>
  <div class="quick_jump_bar w-full my-0 flex flex-row justify-center items-center">
    ...
    <!-- 选择框 -->
    <select
      class="mx-4 px-2 py-4 w-3/4 border border-gray-200 rounded text-lg font-semibold text-center disabled:opacity-50 disabled:pointer-events-none"
      :onchange="handleChange">
      <option class=”rounded-lg“ v-for="book in group_info_filter.BookInfos" :value="book.id" :key="book.id"

...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "^/api/(server_info|book_infos|get_book|get_file|config.toml|comigo.reg|qrcode.png|redirect|upload|form|raw|login|logout|form|group_info_filter|parent_book_info).*":
        {

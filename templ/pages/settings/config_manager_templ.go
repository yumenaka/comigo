...
func ConfigManager(initSaveTo string, WorkingDirectoryConfig string, HomeDirectoryConfig string, ProgramDirectoryConfig string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 23, "\">SAVE</button> <button id=\"deleteConfigButton\" class=\"w-24 h-10 mx-2 my-1 text-center transition bg-red-300 border border-gray-500 rounded\" hx-post=\"/api/config-delete\" hx-include=\"#selectedDir\" hx-target=\"#config-container\" hx-swap=\"outerHTML\" x-text=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}

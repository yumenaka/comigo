...
func BookCard(c echo.Context, book model.BookInfo, bookMarks model.BookMarks) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 32, Col: 26}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 33, Col: 61}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "\" x-show=\"showBook\" class=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\"><!-- 根据书籍类型，选择显示的图标 --><!-- 虽然此处理论上用 switch 语句更简洁，但是vscode目前无法格式化 templ 的switch语句，所以暂时不用 --><!-- Zip，Cbz压缩文件 使用 transform 和 scale 实现“元素放大且不影响原有布局”的效果。核心思路是通过 CSS Transform 做放大动画，而不改变其占据的文档流空间。transition-transform duration-200 hover:scale-105 -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if book.Type == model.TypeZip || book.Type == model.TypeCbz {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<svg x-show=\"$store.shelf.showFileIcon\" class=\"absolute top-0 z-0 w-8 h-8 text-black text-yellow-400 rounded left-1 hover:bg-gray-200 dark:hover:bg-gray-600\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 24 24\"><path stroke=\"black\" stroke-width=\"0.5\" d=\"M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-4 10h2v-2h-2v-2h2v-2h-2V8h4v10h-4v-2zm0 0h-2v2H4V6h5.17l2 2H14v2h2v2h-2v2h2v2z\" fill=\"currentColor\"></path> <g id=\"Layer_Name\"><title>Layer Name</title><text stroke=\"black\" stroke-width=\"0.5\" font-weight=\"bold\" xml:space=\"preserve\" text-anchor=\"start\" font-family=\"Arial\" font-size=\"10\" id=\"svg_1\" y=\"16\" x=\"5\" fill=\"currentColor\">Z</text></g></svg>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		if book.Type == model.TypeBooksGroup {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<div x-show=\"$store.shelf.showFileIcon\" class=\"absolute top-0 z-10 text-black rounded left-1 hover:bg-gray-200 dark:hover:bg-gray-600\"><div class=\"flex text-xl font-black text-yellow-400\" style=\"text-shadow: 0 1px black, 1px 0 black, -1px 0 black, 0 -1px black;\"><svg class=\"w-8 h-8\" style=\"stroke: black; stroke-width: 0.5px;\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 24 24\"><g fill=\"none\"><path d=\"M6.5 2A2.5 2.5 0 0 0 4 4.5v15A2.5 2.5 0 0 0 6.5 22h13.25a.75.75 0 0 0 0-1.5H6.5a1 1 0 0 1-1-1h14.25a.75.75 0 0 0 .75-.75V4.5A2.5 2.5 0 0 0 18 2H6.5zM8 5h8a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1z\" fill=\"currentColor\"></path></g></svg> <span class=\"h-8 font-black text-yellow-400 align-text-bottom text-shadow\">x")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		if book.Type == model.TypeVideo {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "<svg x-show=\"$store.shelf.showFileIcon\" class=\"absolute z-10 w-8 h-8 m-0 text-black rounded shadow-2xl top-1 left-1 hover:bg-gray-200 dark:hover:bg-gray-600\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"rgb(234 179 8)\" viewBox=\"0 0 24 24\" stroke-width=\"1.0\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 2.25 7.5v9a2.25 2.25 0 0 0 2.25 2.25Z\"></path></svg>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}

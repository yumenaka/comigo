...
// 如果链接包含字符串“api/get_file?” 则在背景图片链接中添加参数“&resize_height=360”
func getResizedImageUrl(imageUrl string) string {
	if strings.Contains(imageUrl, "api/get_file?") {
		imageUrl = imageUrl + "&resize_height=360"
	}
	return imageUrl
}
...
func backgroundImage(imageUrl string) templ.CSSClass {
	...
	templ_7745c5c3_CSSBuilder.WriteString(string(templ.SanitizeCSS(`background-image`, "url("+getResizedImageUrl(imageUrl)+")")))
...
func BookCard(c echo.Context, book model.BookInfo, bookMarks model.BookMarks) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 31, Col: 60}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 32, Col: 61}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 33, Col: 20}
		}
		...
		if book.Type == model.TypeBooksGroup {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 85, Col: 123}
			}
		...
		if bookMarks != nil && bookMarks.GetLastReadPage() > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 232, Col: 109}
			}
...
func ReadingProgress(book model.BookInfo, bookMarks model.BookMarks) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if bookMarks != nil && bookMarks.GetLastReadPage() != 0 && bookMarks.GetLastReadPage() < book.PageCount {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 241, Col: 51}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 241, Col: 250}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_book_card.templ`, Line: 241, Col: 269}
			}

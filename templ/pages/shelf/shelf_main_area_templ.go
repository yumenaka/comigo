...
func ShelfSearchBar(c echo.Context) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/shelf/shelf_main_area.templ`, Line: 17, Col: 60}
		}
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(c.QueryParam("keyword"))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\" x-bind:placeholder=\"i18next.t('search_books_placeholder')\" required class=\"w-full h-10 px-2 font-semibold border-2 border-gray-500 dark:border-gray-200 rounded bg-white text-black placeholder-gray-500 focus:outline-none\"> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if getShelfParentID(c) != "" {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(getShelfParentID(c))
			if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<button type=\"submit\" class=\"w-full text-sm text-center inline-flex items-center justify-center px-2.5 py-2 border rounded text-black font-semibold focus:outline-none focus:ring bg-blue-200 transition delay-150 duration-300 ease-in-out hover:bg-indigo-300\" x-text=\"i18next.t('search_button')\"></button></form></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if nowBookNum != 0 && getShelfParentID(c) == "" {
			...
			for i, storeBooks := range storeBookInfos {
				...
				templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs("book-shelf-" + strconv.Itoa(i))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("{ showBook: $persist(true).as('showBook_%s') }", base64.StdEncoding.EncodeToString([]byte(storeBooks.StoreUrl))))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "\" class=\"w-full h-full mt-2 mb-6 border-2 border-gray-500 dark:border-gray-200 rounded flex flex-row flex-wrap content-start justify-center text-base-content relative pt-8\"><!-- 书架标题栏 --><button title=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}

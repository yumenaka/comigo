			...
			if paginationIndex < 1 || (paginationIndex >= 1 && key/32+1 == paginationIndex) {
				...
				if !strings.Contains(image.Url, "hidden.") && !strings.Contains(image.Url, ".html") {
					if c != nil && c.QueryParam("static") == "" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/scroll/scroll_main_area.templ`, Line: 71, Col: 38}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/scroll/scroll_main_area.templ`, Line: 74, Col: 72}
						}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/pages/scroll/scroll_main_area.templ`, Line: 81, Col: 136}
				}

...
func BookCard(c *gin.Context, s *state.GlobalState, book entity.BookInfo) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var3 = []any{backgroundImage(state.GetCloverBackgroundImageUrl(&book)), "relative w-32 mx-4 my-4 bg-top bg-cover h-44 rounded drop-shadow-lg  ring-2 ring-gray-400 hover:ring hover:ring-blue-500 overflow-hidden"}
		...
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(getHref(book))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/shelf/shelf_main_area.templ`, Line: 44, Col: 23}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/shelf/shelf_main_area.templ`, Line: 45, Col: 26}
		}
		...
		templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("{ BookID: %s }", "\""+book.BookID+"\""))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/shelf/shelf_main_area.templ`, Line: 46, Col: 63}
		}
		...
		if book.Type == entity.TypeBooksGroup {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div x-show=\"$store.shelf.showFileIcon\" class=\"absolute top-0 z-10 text-black rounded right-1 hover:bg-gray-200 dark:hover:bg-gray-600\"><div class=\"flex text-xl font-black text-yellow-400\" style=\"text-shadow: 0 1px black, 1px 0 black, -1px 0 black, 0 -1px black;\"><svg class=\"w-8 h-8\" style=\"stroke: black; stroke-width: 0.5px;\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 24 24\"><g fill=\"none\"><path d=\"M6.5 2A2.5 2.5 0 0 0 4 4.5v15A2.5 2.5 0 0 0 6.5 22h13.25a.75.75 0 0 0 0-1.5H6.5a1 1 0 0 1-1-1h14.25a.75.75 0 0 0 .75-.75V4.5A2.5 2.5 0 0 0 18 2H6.5zM8 5h8a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1z\" fill=\"currentColor\"></path></g></svg> <span class=\"h-8 font-black text-yellow-400 align-bottom align-text-bottom text-shadow\">x")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var8 string
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(strconv.Itoa(book.ChildBookNum))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/shelf/shelf_main_area.templ`, Line: 90, Col: 127}
			}
		...
		templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs("$store.shelf.simplifyTitle === true?'" + book.ShortTitle() + "':'" + book.Title + "'")
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/shelf/shelf_main_area.templ`, Line: 214, Col: 154}
		}

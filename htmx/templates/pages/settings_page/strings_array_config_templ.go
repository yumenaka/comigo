...
func StringArrawConfig(value string, description string, config_array []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"flex flex-col justify-start w-full p-2 m-1 font-semibold rounded-md shadow-md hover:shadow-2xl items-left\" style=\"background-color: rgb(245, 245, 228);\"><label class=\"w-32 py-0\" for=\"")
		if templ_7745c5c3_Err != nil {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 10, Col: 54}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 10, Col: 86}
		}
		...
		for _, item := range config_array {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 14, Col: 23}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 19, Col: 29}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 19, Col: 96}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 22, Col: 23}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 23, Col: 60}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 30, Col: 40}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/settings_page/strings_array_config.templ`, Line: 37, Col: 44}
		}

...
func Footer(version string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<footer class=\"w-full p-0 m-0 footer border-t bg-base-100 text-base-content\"><aside class=\"flex flex-row justify-center w-full h-10 py-2 h footer item-center\"><a class=\"text-sm font-semibold text-blue-700 hover:underline\" href=\"https://comigo.xyz\" target=\"_blank\">Power by Comigo ")
		if templ_7745c5c3_Err != nil {

...
func Header(prop HeaderProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<!-- 文件重排序 Dropdown Menu： https://flowbite.com/docs/components/dropdowns/ --><svg class=\"flex justify-center items-center w-8 h-10 mx-1 my-0 rounded hover:ring\" id=\"dropdownHoverButton\" data-dropdown-toggle=\"ReSortDropdown\" data-dropdown-trigger=\"click\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 24 24\"><path d=\"M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z\" fill=\"currentColor\"></path></svg><div id=\"ReSortDropdown\" x-data=\"{\n                    getCurrentSortBy() {\n                        // 根据URL路径决定使用哪个cookie参数名\n                        let paramName = &#39;&#39;;\n                        const currentUrl = window.location.href;\n                        if (currentUrl.includes(&#39;/flip/&#39;)) {\n                            paramName = &#39;FlipSortBy&#39;;\n                        } else if (currentUrl.includes(&#39;/scroll/&#39;)) {\n                            paramName = &#39;ScrollSortBy&#39;;\n                        } else {\n                            paramName = &#39;ShelfSortBy&#39;;\n                        }\n                        \n                        // 获取cookie中的排序方式\n                        const cookies = document.cookie.split(&#39;;&#39;);\n                        for (let i = 0; i &lt; cookies.length; i++) {\n                            const cookie = cookies[i].trim();\n                            if (cookie.startsWith(paramName + &#39;=&#39;)) {\n                                return decodeURIComponent(cookie.substring(paramName.length + 1));\n                            }\n                        }\n                        return &#39;&#39;; // 默认值\n                    },\n                    setCookie(value) {\n                        // 根据URL路径决定使用哪个cookie参数名\n                        const currentUrl = window.location.href;\n                        if (currentUrl.includes(&#39;/flip/&#39;)) {\n                            paramName = &#39;FlipSortBy&#39;;\n                        } else if (currentUrl.includes(&#39;/scroll/&#39;)) {\n                            paramName = &#39;ScrollSortBy&#39;;\n                        } else {\n                            paramName = &#39;ShelfSortBy&#39;;\n                        } \n                        // 设置cookie，过期时间为365天\n                        const expirationDate = new Date();\n                        expirationDate.setDate(expirationDate.getDate() + 365);\n                        document.cookie = paramName + &#39;=&#39; + encodeURIComponent(value) + &#39;; expires=&#39; + expirationDate.toUTCString() + &#39;; path=/; SameSite=Lax&#39;;\n                        window.location.reload();\n                    }\n                }\" class=\"z-10 hidden divide-y divide-gray-100 rounded-lg shadow max-w-fit bg-white/90 dark:bg-gray-700\" x-init=\"currentSortBy = getCurrentSortBy()\"><ul class=\"py-2 text-sm text-gray-700 dark:text-gray-200\" aria-labelledby=\"dropdownHoverButton\"><li><a href=\"#\" @click.prevent=\"setCookie(&#39;filename&#39;)\" x-text=\"i18next.t(&#39;sort_by_filename&#39;)\" :class=\"{&#39;bg-gray-100 dark:bg-gray-600 font-bold border-1 rounded&#39;: currentSortBy === &#39;filename&#39;}\" class=\"block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white\"></a></li><li><a href=\"#\" @click.prevent=\"setCookie(&#39;modify_time&#39;)\" x-text=\"i18next.t(&#39;sort_by_modify_time&#39;)\" :class=\"{&#39;bg-gray-100 dark:bg-gray-600 font-bold border-1 rounded&#39;: currentSortBy === &#39;modify_time&#39;}\" class=\"block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white\"></a></li><li><a href=\"#\" @click.prevent=\"setCookie(&#39;filesize&#39;)\" x-text=\"i18next.t(&#39;sort_by_filesize&#39;)\" :class=\"{&#39;bg-gray-100 dark:bg-gray-600 font-bold border-1 rounded&#39;: currentSortBy === &#39;filesize&#39;}\" class=\"block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white\"></a></li><li><a href=\"#\" @click.prevent=\"setCookie(&#39;filename_reverse&#39;)\" x-text=\"i18next.t(&#39;sort_by_filename_reverse&#39;)\" :class=\"{&#39;bg-gray-100 dark:bg-gray-600 font-bold border-1 rounded&#39;: currentSortBy === &#39;filename_reverse&#39;}\" class=\"block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white\"></a></li><li><a href=\"#\" @click.prevent=\"setCookie(&#39;modify_time_reverse&#39;)\" x-text=\"i18next.t(&#39;sort_by_modify_time_reverse&#39;)\" :class=\"{&#39;bg-gray-100 dark:bg-gray-600 font-bold border-1 rounded&#39;: currentSortBy === &#39;modify_time_reverse&#39;}\" class=\"block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white\"></a></li><li><a href=\"#\" @click.prevent=\"setCookie(&#39;filesize_reverse&#39;)\" x-text=\"i18next.t(&#39;sort_by_filesize_reverse&#39;)\" :class=\"{&#39;bg-gray-100 dark:bg-gray-600 font-bold border-1 rounded&#39;: currentSortBy === &#39;filesize_reverse&#39;}\" class=\"block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white\"></a></li></ul></div></div><!-- 标题--><div class=\"flex flex-col items-center justify-center flex-1 p-0 m-0 font-semibold text-center truncate\"><!-- 标题，快速跳转 or 可下载压缩包 or 只显示 -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if prop.InShelf {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 143, Col: 52}
			}
			...
			if prop.ShowQuickJumpBar && prop.QuickJumpBarBooks != nil {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<button id=\"quickJumpBarDropdownButton\" data-dropdown-toggle=\"QuickJumpDropdown\" data-dropdown-trigger=\"click\" class=\"max-w-fit px-5 py-2.5 inline-flex  hover:bg-gray-400 rounded-lg font-semibold text-center items-center\" type=\"button\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 153, Col: 18}
				}
				...
				for _, book := range prop.QuickJumpBarBooks.BookInfos {
					if prop.FlipMode {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 162, Col: 159}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 166, Col: 161}
						}
				...
				if prop.SetDownLoadLink {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 175, Col: 60}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 178, Col: 54}
					}

...
func Header(prop HeaderProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if prop.InShelf {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 99, Col: 52}
			}
			...
			if prop.ShowQuickJumpBar && prop.QuickJumpBarBooks != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 109, Col: 18}
				}
				...
				for _, book := range prop.QuickJumpBarBooks.BookInfos {
					if prop.FlipMode {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 118, Col: 159}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 122, Col: 161}
						}
				...
				if prop.SetDownLoadLink {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 131, Col: 60}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/common/header.templ`, Line: 134, Col: 54}
					}

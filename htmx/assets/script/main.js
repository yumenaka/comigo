...
Alpine.store('shelf', {
    ...
    simplifyFilename: Alpine.$persist(true).as('shelf.simplifyFilename'),
...
Alpine.store('scroll', {
    nowPageNum: 1,
    simplifyFilename: Alpine.$persist(true).as('scroll.simplifyFilename'),

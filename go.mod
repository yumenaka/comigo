...
require (
	...
	github.com/xxjwxc/public v0.0.0-20220104101827-0914df1169fc // indirect
...
replace github.com/mholt/archiver/v3 v3.5.1 => github.com/yumenaka/archiver/v3 v3.5.2-0.20211208015120-d6aa33461ddb

...
require (
	...
	github.com/mandykoh/prism v0.29.0 // indirect
...
replace github.com/mholt/archiver/v4 v4.0.0-alpha.6 => github.com/yumenaka/archiver/v4 v4.0.0-alpha.1.0.20220319155630-28fa37e63f93
